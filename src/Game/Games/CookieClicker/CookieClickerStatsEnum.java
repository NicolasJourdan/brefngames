...
public enum CookieClickerStatsEnum {
    ...
    COOKIE_CLICKER_NB_CLICKS("COOKIE_CLICKER_NB_CLICKS"),
    COOKIE_CLICKER_BEST_PLAYER("COOKIE_CLICKER_BEST_PLAYER"),
    COOKIE_CLICKER_NB_PERFECT("COOKIE_CLICKER_NB_PERFECT"),
    COOKIE_CLICKER_TOTAL_REQUIRED_CLICKS("COOKIE_CLICKER_TOTAL_REQUIRED_CLICKS"),
    COOKIE_CLICKER_AVERAGE_REQUIRED_CLICKS("COOKIE_CLICKER_AVERAGE_REQUIRED_CLICKS"),

...
public class HangmanController extends AbstractGameController {
	...
	private static void updateHangmanImage(HangmanModel model, HangmanView view){
		...
		if(model.getNumGuessesLeft() > 7){
			...
			case 7  :   view.setImageIcon("/data/Images/hang7.gif");
				break;
			case 6  :   view.setImageIcon("/data/Images/hang6.gif");
				break;
			case 5  :   view.setImageIcon("/data/Images/hang5.gif");
				break;
			case 4  :   view.setImageIcon("/data/Images/hang4.gif");
				break;
			case 3  :   view.setImageIcon("/data/Images/hang3.gif");
				break;
			case 2  :   view.setImageIcon("/data/Images/hang2.gif");
				break;
			case 1  :   view.setImageIcon("/data/Images/hang1.gif");
				break;
			case 0  :   view.setImageIcon("/data/Images/hang0.gif");
				break;
				default :   break;

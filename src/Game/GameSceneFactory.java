...
public class GameSceneFactory implements SceneFactoryInterface {
    ...
    public GameScene createScene(SceneEnum gameEnum) {
        ...
        switch (gameEnum) {
            ...
            case TIC_TAC_TOE:
                return new TicTacToeScene(this.playersList, this.isTraining, this.history);
            case RUNNER:
                return new RunnerScene(this.playersList, this.isTraining, this.history);
            case CONNECT_FOUR:
                return new ConnectFourScene(this.playersList, this.isTraining, this.history);
            case COOKIE_CLICKER:
                return new CookieClickerScene(this.playersList, this.isTraining, this.history);
            case TRAINING_MENU:
